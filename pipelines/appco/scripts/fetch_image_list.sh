...
write_longhorn_env_vars(){
  if [[ -n "${LONGHORN_COMPOMENT_TAG}" ]]; then
    CUSTOM_LONGHORN_ENGINE_IMAGE="${CUSTOM_LONGHORN_ENGINE_IMAGE%:*}:${LONGHORN_COMPOMENT_TAG}"
    CUSTOM_LONGHORN_INSTANCE_MANAGER_IMAGE="${CUSTOM_LONGHORN_INSTANCE_MANAGER_IMAGE%:*}:${LONGHORN_COMPOMENT_TAG}"
    CUSTOM_LONGHORN_MANAGER_IMAGE="${CUSTOM_LONGHORN_MANAGER_IMAGE%:*}:${LONGHORN_COMPOMENT_TAG}"
    CUSTOM_LONGHORN_SHARE_MANAGER_IMAGE="${CUSTOM_LONGHORN_SHARE_MANAGER_IMAGE%:*}:${LONGHORN_COMPOMENT_TAG}"
    CUSTOM_LONGHORN_BACKING_IMAGE_MANAGER_IMAGE="${CUSTOM_LONGHORN_BACKING_IMAGE_MANAGER_IMAGE%:*}:${LONGHORN_COMPOMENT_TAG}"
    CUSTOM_LONGHORN_UI_IMAGE="${CUSTOM_LONGHORN_UI_IMAGE%:*}:${LONGHORN_COMPOMENT_TAG}"
  fi
